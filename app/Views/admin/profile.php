...
<div class="container">
    ...
    <div class="card card-custom card-stretch">
        ...
        <div class="card-header py-3">
            ...
            <div class="card-toolbar">
                <button type="button" class="btn btn-warning mr-2" data-toggle="modal" data-target="#edit<?= $user['id_user'] ?>">
                    Edit Profile
                </button>
            </div>
        </div>
                        ...
                        <div class="card card-custom card-stretch card-border">
                            ...
                            <div class="card-body">
                                <div class="text-center">
                                    ...
                                    <?php } else { ?>
                                        <img class="img-fluid pad" width="200px" height="200px" src="<?= base_url('foto/' . $user['foto']) ?>" id="gambar_load">
                                    <?php } ?>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <p class="text-dark-50"><?= $user['nama_user'] ?></p>
                                    </div>
                                    <div class="col-sm-6">
                                        <label class="font-weight-bolder">Email</label>
                                        <p class="text-dark-50"><?= $user['email'] ?></p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <label class="font-weight-bolder">No.Telepon</label>
                                        <p class="text-dark-50"><?= $user['telepon'] ?></p>
                                    </div>
    ...
    <div class="modal fade" id="edit<?= $user['id_user'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <?php echo form_open_multipart('Admin/editProfile/' . $user['id_user']) ?>
                <!--begin::Form-->
                <form class="form-group">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label>Nama</label>
                            <input type="text" class="form-control mb-3" name="nama_user" value="<?= $user['nama_user'] ?>" required />
                            <label>Email</label>
                            <input type=" email" class="form-control mb-3" name="email" value="<?= $user['email'] ?>" required />
                            <label>No.Telepon</label>
                            <input type="text" class="form-control mb-3" name="telepon" value="<?= $user['telepon'] ?>" required />
                            ...
                            <div class="row">
                                <div class="col-3">
                                    ...
                                    <?php } else { ?>
                                        <img src="<?= base_url('foto/' . $user['foto']) ?>" alt="" class="img-thumbnail pt-10">
                                    <?php } ?>
                                </div>
                                <div class="col-9">
