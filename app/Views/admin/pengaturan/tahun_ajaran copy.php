                ...
                <form class="form-group">
                    <div class="modal-body">
                        <div class="card-body">
                            ...
                            <div class="mb-3 row">
                                <div class="col">
                                    ...
                                    <div class="input-group date">
                                        <input type="text" class="form-control" id="kt_datepicker_2" readonly="readonly" name="tanggal_mulai_pendaftaran" required />
                                ...
                                <div class="col">
                                    ...
                                    <div class="input-group date">
                                        <input type="text" class="form-control" id="kt_datepicker_2" readonly="readonly" name="tanggal_selesai_pendaftaran" required />
                                        <div class="input-group-append">
                                            <span class="input-group-text">
                                                <i class="la la-calendar-check-o"></i>
                                            </span>
                            ...
                            <div class="mb-3 row">
                                <div class="col">
                                    <label>Tanggal Mulai Seleksi</label>
                                    <div class="input-group date">
                                        <input type="text" class="form-control" id="kt_datepicker_2" readonly="readonly" name="tanggal_mulai_seleksi" required />
                                        <div class="input-group-append">
                                            <span class="input-group-text">
                                                <i class="la la-calendar-check-o"></i>
                                            </span>
                                ...
                                <div class="col">
                                    <label>Tanggal Selesai Seleksi</label>
                                    <div class="input-group date">
                                        <input type="text" class="form-control" id="kt_datepicker_2" readonly="readonly" name="tanggal_selesai_seleksi" required />
                                        <div class="input-group-append">
                                            <span class="input-group-text">
                                                <i class="la la-calendar-check-o"></i>
                                            </span>
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    ...
                                    <div class="input-group date">
                                        <input type="text" class="form-control" id="kt_datepicker_2" readonly="readonly" name="tanggal_pengumuman" required />
                                        <div class="input-group-append">
                                            <span class="input-group-text">
                                                <i class="la la-calendar-check-o"></i>
                                            </span>
                            ...
                            <div class="mb-3 row">
                                <div class="col">
                                    ...
                                    <div class="input-group date">
                                        <input type="text" class="form-control" id="kt_datepicker_2" readonly="readonly" name="tanggal_mulai_daftar_ulang" required />
                                        <div class="input-group-append">
                                            <span class="input-group-text">
                                                <i class="la la-calendar-check-o"></i>
                                            </span>
                                ...
                                <div class="col">
                                    ...
                                    <div class="input-group date">
                                        <input type="text" class="form-control" id="kt_datepicker_2" readonly="readonly" name="tanggal_selesai_daftar_ulang" required />
                                        <div class="input-group-append">
                                            <span class="input-group-text">
                                                <i class="la la-calendar-check-o"></i>
                                            </span>
