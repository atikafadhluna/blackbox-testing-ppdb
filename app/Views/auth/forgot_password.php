                ...
                <div class="card card-custom gutter-b">
                    <div class="card-body">
                        ...
                        <div class="login-signin">
                            ...
                            <?php echo form_open('auth/cek_forgotpassword') ?>
                            <div class=" form-group" id="kt_login_signin_form">
                                <label>Masukkan Email Anda</label>
                                <input class="form-control <?= $validation->hasError('email') ? 'is-invalid' : null ?> h-auto text-dark bg-dark-o-10 rounded-pill border-0 py-4 px-8 " type="email" placeholder="Email" name="email" />
