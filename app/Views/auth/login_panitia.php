                    ...
                    <div class="card-body">
                        ...
                        <div class="login-signin">
                            ...
                            <div class=" form-group" id="kt_login_signin_form">
                                <input class="form-control h-auto text-dark bg-dark-o-10 rounded-pill border-0 py-4 px-8 " type="email" placeholder="Email" name="email" value="<?= old('email'); ?>" />

                            </div>
                            <div style="text-align: left;"><label class="ml-2">Password</label></div>
                            <div class="form-group">

                                <input class="form-control h-auto text-dark bg-dark-o-10 rounded-pill border-0 py-4 px-8 " type="password" placeholder="Password" name="password" value="<?= old('password'); ?>" />
                            ...
                            <!-- <div class="form-group d-flex flex-wrap justify-content-between align-items-center px-8 ">
                                ...
                                <a href="<?= base_url('auth/forgotpassword') ?>" class="font-weight-bold">Forget Password ?</a>
                            </div> -->
