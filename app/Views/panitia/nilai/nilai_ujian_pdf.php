...
<body>
    <div class="container">
        ...
        <h4>
            <center>
                NILAI UJIAN PENERIMAAN PESERTA DIDIK BARU <br>
            ...
            <table style="width: 100%;border-collapse: collapse;">
                ...
                foreach ($nilaimanual as $key => $value) { ?>
                    <tr>
                        ...
                        <td style="border: 1px solid; padding: 8px; text-align:center;"><?= $value['nilai_akhir'] ?></td>
                        <td style="border: 1px solid; padding: 8px; text-align:center;"><?php if ($value['nilai_akhir'] >= $kkm['kkm_kelulusan']) { ?>
