<div id="kt_header" class="header header-fixed">
    ...
    <!--begin::Container-->
    <div class="container-fluid d-flex align-items-stretch justify-content-between bc-kemenag">
        ...
        <div class="topbar">
            <div class="topbar-item">
                <div class="dropdown btn-group">
                    <button class="btn btn-icon w-auto btn-clean d-flex align-items-center btn-lg px-2 dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class=" font-weight-bolder font-size-base d-none d-md-inline mr-3"> <?= session()->get('nama_user') ?></span>
                        <span class="symbol symbol-35 symbol-light-success">

                            <?php if ($user['foto'] == null) { ?>
                                <img class="h-35px w-60px rounded-sm" src="<?= base_url('foto/blank.png') ?>" id="gambar_load">
                            <?php } else { ?>
                                <img class="h-35px w-60px rounded-sm" src="<?= base_url('foto/' . $user['foto']) ?>" id="gambar_load">
                            <?php } ?>
                        </span>
                    </button>
                    <div class="dropdown-menu">
                        <div class="navi navi-spacer-x-0 mr-5 ml-5">
                            <!--begin::Item-->
                            <a href="<?= base_url('Admin/profile'); ?>" class="dropdown-item navi-item">
                                <div class="navi-link">
                                    ...
                                    <div class="navi-text">
                                        <div class="font-weight-bold mr-15">Profile</div>
                                    </div>
                                </div>
                            </a>
                            <!--end:Item-->
                            ...
                            <!--begin::Item-->
                            <a href="<?= base_url('Admin/changePassword'); ?>" class="dropdown-item navi-item">
                                <div class="navi-link">
                                    <div class="symbol symbol-40 bg-light mr-3">
                                        <div class="symbol-label">
                                    ...
                                    <div class="navi-text">
                                        <div class="font-weight-bold mr-15">Ubah Password</div>
                                    </div>
                                </div>
                            </a>
                            <!--end:Item-->
                            ...
                            <!--begin::Item-->
                            <a href="<?= base_url('auth/logout'); ?>" class="dropdown-item navi-item">
                                <div class="navi-link">
                                    <div class="symbol symbol-40 bg-light mr-3">
                                        <div class="symbol-label">
                                    ...
                                    <div class="navi-text">
                                        <div class="font-weight-bold mr-15">Keluar</div>
                                    </div>
                                </div>
                            </a>
                            <!--end:Item-->
