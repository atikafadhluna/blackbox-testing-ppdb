<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
    ...
    <div class="brand flex-column-auto" id="kt_brand">
        ...
        <!--begin::Logo-->
        <a href="<?= base_url('panitia/index') ?>" class="brand-logo">
        ...
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
            ...
            <ul class="menu-nav">
                <li class="menu-item menu-item-active" aria-haspopup="true">
                    <a href="<?= base_url('panitia/index') ?>" class="menu-link">
                ...
                <li class="menu-item <?= ($title == "Bank Soal") ? 'menu-item-active' : '' ?>" aria-haspopup="true" data-menu-toggle="hover">
                    <a href="<?= base_url('Panitia/soal') ?>" class="menu-link menu-toggle">
                        <span class="svg-icon menu-icon">
                ...
                <li class="menu-item <?= ($title == "Ujian") ? 'menu-item-active' : '' ?>" aria-haspopup="true" data-menu-toggle="hover">
                    <a href="<?= base_url('Panitia/Ujian') ?>" class="menu-link menu-toggle">
                        <span class="svg-icon menu-icon">
                            <!--begin::Svg Icon | path:assets/media/svg/icons/Shopping/Barcode-read.svg-->
                            <span class="svg-icon svg-icon-2x">
                ...
                <li class="menu-item <?= ($title == "Nilai Ujian") ? 'menu-item-active' : '' ?>" aria-haspopup="true" data-menu-toggle="hover">
                    <a href="<?= base_url('Panitia/Nilai') ?>" class="menu-link menu-toggle">
                        <span class="svg-icon menu-icon">
                            <!--begin::Svg Icon | path:assets/media/svg/icons/Shopping/Barcode-read.svg-->
                            <span class="svg-icon svg-icon-2x">
                        ...
                        <span class="menu-text">Nilai Ujian</span>
                    </a>
                </li>
                <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                    <a href="<?= base_url('auth/logoutpanitia') ?>" class="menu-link menu-toggle">
                        <span class="svg-icon menu-icon">
